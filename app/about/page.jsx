      ...
      <div className="flex items-center flex-col gap-10">
        <div className="flex gap-2 flex-col w-full">
          ...
          <p className="text-sm leading-normal">
            ...
            wallet integrated NFT marketplace interface. I'm currently dealing with interface
            development. <br /> <br /> I develop projects with a mobile-first approach based on
            technologies such as JavaScript, React, NextJS, Tailwind CSS, SASS, which focus on
            responsive design. I am someone who is interested in technological developments and
            always strives to improve myself. The frontend development world is changing rapidly and
            I am constantly trying to improve myself to be aware of these changes.
        ...
        <div className="flex gap-2 flex-col w-full">
          <h3 className="text-base font-medium text-white">Education</h3>
          <p className="text-sm leading-normal">
            {" "}
