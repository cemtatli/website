    ...
    },
    {
      ...
      technologies: [
        ...
        { title: "Redux Toolkit", icon: "https://img.icons8.com/color/128/redux.png" },
        {
          ...
          icon: "https://img.icons8.com/color/128/styled-components.png"
        },
  ...
  return (
    <div className="mt-5 flex flex-col items-start gap-4">
      {techs.map((category, index) => (
        <div key={index}>
          <span className="text-start text-sm font-medium uppercase">{category.title}</span>
          <div className="my-2 grid grid-cols-5 gap-4 md:flex md:flex-wrap">
            {category.technologies.map((tech, techIndex) => (
              <HoverCard key={techIndex}>
                ...
                <HoverCardContent className="!w-fit px-3 py-1.5 text-sm">
                  {tech.title}
                </HoverCardContent>
              </HoverCard>
            ))}
